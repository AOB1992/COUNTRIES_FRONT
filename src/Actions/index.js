...
export function loadCountries (payload) {
 ...
 return function (dispatch){
  return fetch('countriesback-production-bffc.up.railway.app/countries')
...
export function SET_DETAIL (payload) {
  ...
  console.log(payload)
    ...
    return function (dispatch){
      return fetch(`countriesback-production-bffc.up.railway.app/countries/${payload}`)
        .then(response => response.json())
          .then(json => {
...
export function SET_ARRAY_ON_CHANGE (payload) {
  ...
  console.log(payload)
    ...
    return function (dispatch){
      return fetch(`countriesback-production-bffc.up.railway.app/countries?name=${payload}`)
        .then(response => response.json())
          .then(json => {
